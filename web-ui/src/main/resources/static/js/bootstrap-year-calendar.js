 ...
 * ========================================================= */
 ...
 (function($) {
		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
					monthContainerClass += ' col-sm-2 float-left';
				}
				else if(monthSize * 4 < calendarSize) {
					monthContainerClass += ' col-sm-3 float-left';
				}
				else if(monthSize * 3 < calendarSize) {
					monthContainerClass += ' col-sm-4 float-left';
				}
				else if(monthSize * 2 < calendarSize) {
					monthContainerClass += ' col-sm-6 float-left';
				}
				else {
					monthContainerClass += ' col-sm-12 float-left';
				}
	...
	var colors = $.fn.calendar.colors = ['#ff0033'];
