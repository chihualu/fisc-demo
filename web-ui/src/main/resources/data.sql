...
INSERT INTO WEB_ROLE_INFO (ROLE_ID, ROLE_NAME, FUNC_LIST) VALUES
    ('ROLE1', '使用者群組1', '{"folder.system":[],"system.users":["q","m"],"system.roles": ["q","m"],"folder.fisc":[],"fisc.notice":["x"],"fisc.status.query":["x"]}'),
...
INSERT INTO WEB_FUNC_INFO (FUNC_ID, FUNC_NAME, FUNC_URL, HIDDEN, PARENT_ID, ORDER_NUM, ACTIONS) VALUES
    ...
    ('fisc.status.query', '查詢行庫狀態', '/web/fisc/status', false, 'folder.fisc', 2, '["q", "m"]');

--INSERT INTO WEB_BANK_INFO (BANKCODE, BANKNAME, TELZONE, TELNO, UPDATEDATE) VALUES
--    ('987', 'XX銀行', '02', '23456789', '20220511'),
--    ('988', 'OO銀行', '02', '23456788', '20220512');
